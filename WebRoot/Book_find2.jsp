<%@ page language="java" contentType="text/html; charset=UTF-8" import="java.util.*,pojo.User,pojo.Book"%>
  ...
  <body>
	...
	<div id="old">
		<table  border="2px">
  			...
  			<tbody>
  				<tr>
  					<td>${requestScope.book.bname}</td>
  					<td>${requestScope.book.classify }</td>
  				</tr>
  			</tbody>
  		</table>
</div>
